...
class MergeData:
    ...
    def pkl_dump_x(self, x):
        inputdata = open(file_location + r"/inputdata2.pkl", "wb")
        pickle.dump(x, inputdata)
        inputdata.close()         

    def pkl_dump_y(self, y):
        outputdata = open(file_location + r"/outputda2ta.pkl", "wb")
    ...
    def mergeInputFile(self): 
        ...
        x = pd.DataFrame() 
        t0 = time.time()
        for i in range(int(numbers/10)*2+1, int(numbers/10)*4+1):
    ...
    def pkl_load_x(self):
        ...
        inputdata = open(file_location + r"/inputdata2.pkl", "rb")
    ...
    def pkl_load_y(self):
        outputdata = open(file_location + r"/outputdata2.pkl", "rb")
